...
public class UpdateUserFragment extends BaseFragment implements TitleBar.OnTitleBarListener,
    ...
    public static UpdateUserFragment newInstance(UserModel userModel, int idUser, String userCode) {

        Bundle args = new Bundle();
        args.putInt(KEY_DATA, idUser);
        args.putString(KEY_DATA_TWO, userCode);
        args.putParcelable(KEY_DATA_THREE, userModel);
...
//        if (savedInstanceState == null) {
        ...
        userModel = getArguments().getParcelable(KEY_DATA_THREE);
//        } else {
...
//        }
        ...
        tvUserCode.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvUserCode));
        tvLastName.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvLastName));
        tvFirstName.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvFirstName));
        tvLastNickName.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvLastNickName));
        tvFirstNickName.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvFirstNickName));
        tvNote.addTextChangedListener(new UpdateUserFragment.GenericTextWatcher(tvNote));
